  ...
  <script>
  	...
  	function fCheck() {
    	...
    	let extraAddress = myForm.extraAddress.value + " ";
  		...
  		if(idCheckSw == 0) {
  			$("html,body,.midRegCheck").animate({
          scrollTop: 0
        }, 150);
  		}
  		else if(submitFlag == 1 && idCheckSw == 1 && pwdCheckSw == 1 && agree1 == true && agree2 == true) {
  			myForm.email.value = email;
    		myForm.tel.value = tel;
  			myForm.address.value = postcode + "/" + roadAddress + "/" + detailAddress + "/" + extraAddress + "/";
    		myForm.agree.value = 1;
	  				...
	  				<td colspan="2">
	  					...
	  					<div class="form-check">
	  						<label for="agree1" class="form-check-label">
									<input type="checkbox" id="agree1" class="form-check-input agree"/>[필수] 이용약관 동의
	  						</label>
	  					</div>
	...
	② "몰"과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
	  					...
	  					<div class="form-check">
	  						<label for="agree2" class="form-check-label">
									<input type="checkbox" id="agree2" class="form-check-input agree"/>[필수] 개인정보 수집 및 이용
	  						</label>
	  					</div>
	  					<textarea class="form-control" rows="7" readonly>
