    ...
    <div class="col p-3 text-center" style="border:1px solid #ccc">
		...
		<div class="col p-3 text-right">
		  ...
		  <div class="text-right p-2">
		    <input type="button" value="옵션등록" onclick="location.href='${ctp}/dbShop2/dbOption?productName=${productVO.productName}';" class="btn btn-success"/>
		    <input type="button" value="돌아가기" onclick="location.href='${ctp}/dbShop2/dbShopList';" class="btn btn-primary"/>
		  </div>
		</div>
  </div>
  <br/><br/>
