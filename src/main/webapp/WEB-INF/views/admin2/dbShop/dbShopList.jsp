...
<p><br/></p>
<div class="container">
  <span>[<a href="${ctp}/dbShop2/dbShopList">전체보기</a>]</span> /
  <c:forEach var="subTitle" items="${subTitleVOS}" varStatus="st">
  	<span>[<a href="${ctp}/dbShop2/dbShopList?part=${subTitle.categorySubName}">${subTitle.categorySubName}</a>]</span>
  ...
  <div class="row">
    ...
    <div class="col text-right">
		  <button type="button" class="btn btn-primary" onclick="location.href='${ctp}/dbShop2/dbProduct';">상품등록하러가기</button>
    </div>
  </div>
  <hr/>
    ...
    <c:forEach var="vo" items="${productVOS}">
      <div class="col-md-4">
        <div style="text-align:center" class="mt-1">
          <a href="${ctp}/dbShop2/dbShopContent?idx=${vo.idx}">
